...
/* gaps.patch */
static const unsigned int gapi = 10;
static const unsigned int gapo = 10;
...
static const MonitorRule monrules[] = {
    ...
    */
    ...
    /* defaults */
    {NULL, 0.5, 1, 2, &layouts[0], WL_OUTPUT_TRANSFORM_NORMAL},
};
...
static const char *menucmd[] = {"fuzzel",
                                "--font=ComicCodeLigatures Nerd Font:size=14",
                                "--prompt= ",
                                "--lines=5",
                                "--horizontal-pad=0",
                                "--vertical-pad=0",
                                ...
                                "--background=303446ff",
                                "--text-color=c6d0f5ff",
                                "--match-color=e78284ff",
                                "--selection-color=99d1dbff",
                                "--selection-text-color=303446ff",
                                "--border-width=0",
                                "--border-radius=0",
                                "--show-actions",
                                NULL};
